<%@ Page Title="" Language="C#" MasterPageFile="~/SiteVeterinario.Master" AutoEventWireup="true" CodeBehind="WebMuestraPlato.aspx.cs" Inherits="VeterinarySmiles_Web.WebMuestraPlato" %>
    ...
    <form id="form1" runat="server">
        <div class="form-box">
            <section class="content-header">
                <h2>Lista de Platos que componen este menú</h2>
            </section>
